  ...
  return {
    ...
    openGraph: {
      ...
      images: course.image_url
        ...
        : [{ url: `/images/og-image.webp`, width: 1200, height: 630, alt: title }],
    },
    twitter: {
      card: 'summary_large_image',
      title: `${title} | Albert Structural`,
      description,
      images: course.image_url ? [course.image_url] : [`/images/og-image.webp`],
    },
  };
}
...
export default async function CourseSyllabusPage({
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url(/images/Fondos%20de%20marketing/Fondo_cslugm.webp)`,
