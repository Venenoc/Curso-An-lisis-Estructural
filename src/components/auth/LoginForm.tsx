...
export default function LoginForm() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url('/images/FondoAut/FondoLog.webp')`,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3 sm:space-y-4 mb-4 sm:mb-6">
          ...
          <div className="flex flex-col items-center pt-2">
            <Button 
              type="submit" 
              disabled={isSubmitting}
              className="px-8 py-2 rounded-full bg-cyan-400 hover:bg-cyan-500 text-slate-900 font-bold transition-colors mb-6"
            >
